...
public class DB_manipulator {
    ...
    public static void saveGame(Connection connection, int score, String name, Square[][] squares){
    ...
    public static void replaceSaveGame(Connection connection, int score, String name, Square[][] squares, int playerid){
        int squareid=1;
        try {
            Statement statement = connection.createStatement();
            for(int i = 0; i < 4; i++){
